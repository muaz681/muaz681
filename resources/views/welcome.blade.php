	...
	@section('frontend_common_section')
        ...
        <div class="slider-area brown__nav slider--15 slide__activation slide__arrow01 owl-carousel owl-theme">
	        ...
	        <div class="slide animation__style10 bg-image--1 fullscreen align__center--left" style="background-image: url({!! asset('uploads/banner_images') !!}/{{ $banner_image->banner_photo }});">
	            <div class="container">
	            	<div class="row">
	            		<div class="col-lg-12">
	            			<div class="slider__content">
		            			<div class="contentbox">
		            				<h2><span>{{ $banner_image->banner_title }}</span></h2>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="{{ url('productdetails') }}/{{ $product->id }}/{{ Str::slug($product->product_name) }}"><img src="{!! asset('uploads/product_images') !!}/{{ $product->product_photo }}" alt="product image"></a>
								<a class="second__img animation1" href="{{ url('productdetails') }}/{{ $product->id }}/{{ Str::slug($product->product_name) }}"><img src="images/books/2.jpg" alt="product image"></a>
								<div class="hot__box">
				...
				<div class="tab__container mt--60">
							...
							@foreach ($products as $product)
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
										<div class="product__thumb">
											<a class="first__img" href="{{ url('productdetails') }}/{{ $product->id }}/{{ Str::slug($product->product_name) }}"><img src="{!! asset('uploads/product_images') !!}/{{ $product->product_photo }}" alt="product image"></a>
											<a class="second__img animation1" href="{{ url('productdetails') }}/{{ $product->id }}/{{ Str::slug($product->product_name) }}"><img src="{!! asset('uploads/product_images') !!}/{{ $product->product_photo }}" alt="product image"></a>
											<div class="hot__box">
					...
					@foreach ($categories as $category)
						<div class="row single__tab tab-pane fade" id="nav-{{ $category->id }}" role="tabpanel">
							@php
								$category_wise_products = App\Models\Product::where('category_id', $category->id)->get();
							@endphp
						<div class="product__indicator--4 arrows_style owl-carousel owl-theme">
							@foreach ($category_wise_products as $product)
								<div class="single__product">
								<!-- Start Single Product -->
								<div class="col-lg-3 col-md-4 col-sm-6 col-12">
									<div class="product product__style--3">
