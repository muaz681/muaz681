        		...
        		<div class="row">
        			<div class="col-lg-9 col-12">
        				<div class="wn__single__product">
                          ...
                          <a href="1.jpg"><img src="{!! asset('uploads/product_images') !!}/{{ $product_info->product_photo }}" alt=""></a>
                          @foreach ($product_info->relationtoproductgallerytable as $single_product_info)
                            <a href="1.jpg"><img src="{!! asset('uploads/product_gallery') !!}/{{ $single_product_info->product_multiple_photo }}" alt=""></a>
                          @endforeach
	        							</div>
        							</div>
        						</div>
                      ...
                      @endif
        							<div class="product__info__main">
										...
										<div class="product__overview">
        									<p>{{ $product_info->product_short_text ?? "Product Short Description Not Available!" }}</p>
                          ...
                          <input type="hidden" name="product_id" value="{{ $product_info->id }}">
										...
										<div class="product_meta">
											<span class="posted_in">Categories:
												<a href="#">{{ $product_info->relationtocetagorytable->category_name }}</a>
											</span>
										</div>
	                        ...
	                        <div class="tab__container">
	                        	...
	                        	<div class="pro__tab_label tab-pane fade show active" id="nav-details" role="tabpanel">
									<div class="description__attribute">
										<p>{{ $product_info->product_long_text ?? "Product Long Description Not Available!" }}</p>
									</div>
	                        	</div>
                  ...
                  @foreach ($related_products as $related_product)
                    <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="product__thumb">
											<a class="first__img" href="{{ url('productdetails') }}/{{ $related_product->id }}/{{ Str::slug($related_product->product_name) }}"><img src="{!! asset('uploads/product_images') !!}/{{ $related_product->product_photo }}" alt="product image"></a>
											<a class="second__img animation1" href="{{ url('productdetails') }}/{{ $related_product->id }}/{{ Str::slug($related_product->product_name) }}"><img src="{!! asset('uploads/product_images') !!}/{{ $related_product->product_photo }}" alt="product image"></a>
											<div class="hot__box">
                  ...
                  @endforeach
        			...
        			<div class="col-lg-3 col-12 md-mt-40 sm-mt-40">
                      ...
                      @foreach (App\Models\Category::all() as $category)
                        <li><a href="#">{{ $category->category_name }} <span>({{ App\Models\Product::where('category_id', $category->id)->count() }})</span></a></li>
